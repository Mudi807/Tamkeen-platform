...
export default function JobseekerDashboard() {
  ...
  const handleGenerateBio = () => {
    ...
    const bio = `كفاءة طموحة وتمتلك خبرة في (${experience \vert{}\vert{} 'المجال الإداري والتنفيذي'}). تتميز بمهارات عالية في: ${skills}. تسعى للانضمام إلى فريق عمل ديناميكي لتقديم قيمة مضافة وتحقيق أهداف المنظمة بكفاءة عالية.`;
    setGeneratedBio(bio);
  };
